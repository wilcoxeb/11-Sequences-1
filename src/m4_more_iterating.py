...
def run_test_count_positive_sines():
    ...
    # Test 11
    expected = 3
    actual = count_positive_sines([5, 4, 6, 3, 2, 1, 0])
    print()
...
def run_test_sum_first_n():
    ...
    # Test 8:
    expected = 69
    actual = sum_first_n([37, 34, -2, 56, 78], 3)
    print()
    print('Test 8 expected:', expected)
    print('       actual:  ', actual)
    ...
    # Test 9:
    expected = 90
    actual = sum_first_n([12, 13, 14, 15, 11, 12, 13, 14, 14], 7)
    print()
    print('Test 9 expected:', expected)
    print('       actual:  ', actual)
